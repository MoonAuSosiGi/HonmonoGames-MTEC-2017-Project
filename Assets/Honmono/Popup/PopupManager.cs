...
public class PopupManager : Singletone<PopupManager> {
    ...
    public void AddPopup(string popupName)
    {
        ...
        if (m_popupQueue.Count == 1)
            iTween.ScaleTo(popup, iTween.Hash("x", 1.0f, "y", 1.0f, "easetype", "easeInOutBack", "time", 1.5f));
    }
    ...
    public void ClosePopup(GameObject popup)
    {
        ...
        if (obj == popup)
        {
            iTween.ScaleTo(popup, iTween.Hash("x", 0.0f, "y", 0.0f, "easetype", "easeInOutBack", "time", 1.5f, 
    ...
    void PopupCloseEnd()
    {
        ...
        if (m_popupQueue.Count > 0)
        {
            ...
            iTween.ScaleTo(obj, iTween.Hash("x", 1.0f, "y", 1.0f, "easetype", "easeInOutBack", "time", 1.5f));
        }
    }
}
